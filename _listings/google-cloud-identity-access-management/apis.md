...
- name: Google Cloud Identity & Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-cloud-identity-access-management/master/_listings/google-cloud-identity-access-management/v1-resource-testiampermissions-post.md
x-common:
- type: x-concepts
